...
| [amd-4dgs-series-01](PhysicalAI/amd-4dgs-series-01/) （[文章](PhysicalAI/amd-4dgs-series-01/README.md)） | 从单目视频构建 4DGS 动态世界表示，让 Physical AI 看懂正在变化的真实世界。 / Building a 4DGS dynamic-world representation from monocular video so Physical AI can understand a changing real world. |
